...
{
    public class CarFactory : IFactory<CarType, Vector3, NPCCarController>
    {
        ...
        public NPCCarController Create(CarType vehicleType, Vector3 spawnPosition)
        {
            ...
            var carController = newCar.AddComponent<NPCCarController>();
