...
{
    public class bPresenter : IScreenPresenter
    {
        private readonly IScreenStateMachine _screenStateMachine;
        private readonly bScreenModel _screenModel;
        private readonly bScreenView _screenView;
        ...
        public bPresenter(IScreenStateMachine screenStateMachine, 
            bScreenModel screenModel, bScreenView screenView)
        {
