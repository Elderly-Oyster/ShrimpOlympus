...
namespace CodeBase.Editor.ModuleCreator
{
    public class ModuleCreatorWindow : EditorWindow
    {
        ...
        private static readonly string TrackingFilePath = "Assets/Root/Editor/ModuleCreator/CreatedModules.json";
        ...
        private void OnGUI()
        {
            ...
            GUILayout.Space(Spacing);
            GUILayout.Label("Select Root to Create", EditorStyles.boldLabel);
