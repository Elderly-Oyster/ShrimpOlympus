...
namespace CodeBase.Core.Popups
{
    //TODO вынести системы в глобальный контекст (CodeBase) чтобы их мог видеть кор и импоементейшн
    ...
    {
        [Inject][HideInInspector] public IPopupCanvas Canvas;
